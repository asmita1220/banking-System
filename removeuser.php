...
<body style="background-image : url(007.jpg); background-size: 1900px; ">
<?php
    include 'config.php';
...
<div class="container">
        <h2 class="text-center pt-4" style="color : #261a0d;">Remove Users</h2>
        <br>
            <div class="row">
                <div class="col">
                    <div class="table-responsive-sm">
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered table-transparent" style="border-color:white;">
                        <thead style="color : black; font-size:25px">
                            <tr>
