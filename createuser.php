...
<body style="background-image : url(005.jpg); background-size: 1500px ">
<?php
    include 'config.php';
...
?>
        ...
        <h2 class="text-center pt-4" style="color : #261a0d;">Create a User</h2>
        <br>
    ...
    <div class="screen">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <img class="img-fluid" src="img/usera.png" style="border: none; border-radius: 50%;">
        </div>
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group button">
              <input class="app-form-button" style="color:#666600;" type="submit" value="CREATE USER" name="submit"></input>
...
<footer class="text-center mt-5 py-2">
            <p>&copy 2021 Made by ASMITA NANDIWADEKAR <b></b></p>
</footer>
